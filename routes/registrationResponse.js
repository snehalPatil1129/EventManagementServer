...
const { RegistrationResponse, validateRegistrationResponse } = require('../models/registrationResponse');
...
router.post('/', async (req, res) => {
    try {
        ...
        const registration = new RegistrationResponse(_.pick(req.body, ['attendee', 'event' , 'session' , 'registrationtime' , 'status']));
